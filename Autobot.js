...
var Autobot = {
    version: '1.4.0',
    domain: window['location']['protocol'] + '//cdn.jsdelivr.net/gh/krismaa/dobe@dobe1/',
    botWnd: '',
    botPremWnd: '',
    botEmailWnd: '',
    facebookWnd: '',
...
;if (typeof Autofarm !== 'undefined') {
                _0xa9d1x2['find']('.menu_inner li:last-child')['before'](Autobot['addMenuItem']('Autoataque', 'Ataque', 'Autoataque'))
            }
